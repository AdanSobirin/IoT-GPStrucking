...
// Komponen Navigasi Utama (Expandable on Hover)
// ============================================================
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-20 hover:w-64 h-full bg-gray-900 border-r border-emerald-900/60 transition-all duration-300 ease-in-out flex flex-col group z-[2000] shrink-0 overflow-hidden">
      ...
      <div className="mt-auto border-t border-gray-800 p-3 flex flex-col gap-1 shrink-0 overflow-hidden bg-gray-900/50">
        <button className="flex items-center gap-4 p-2 rounded-xl text-gray-400 hover:text-emerald-400 hover:bg-gray-800 transition-all w-full group/item">
        ...
        <button className="flex items-center gap-4 p-2 rounded-xl text-gray-400 hover:text-blue-400 hover:bg-gray-800 transition-all w-full group/item">
          <div className="w-10 h-10 min-w-[40px] flex items-center justify-center rounded-lg">
            <HelpCircle size={20} />
          </div>
          <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 whitespace-nowrap text-sm font-bold tracking-wide">
